...
for scene_id, changes_list in list(data.items()):
    ...
    # for i, changes in enumerate(changes_list):
        ...
        # context_change = ""  # No context change in ScanQA format
        # question_answers = changes_list  # Each `changes_list` is already the list of QAs
        
    for j, qa in enumerate(changes_list):
        ...
        text_prompt = template.format(question)
        ...
        print(f'Processed scene {scene_id}, question {j + 1}')
