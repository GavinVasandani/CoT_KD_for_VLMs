...
parser.add_argument("-a", "--adapter_dir", type=str, default="lora_finetuned_qwen", help="Path to your LoRA adapter directory (with adapter_config.json + adapter_model.bin)")
...
for scene_id, changes_list in list(data.items()):
    ...
    save_json(data, f"{args.model_id.split('/')[1]}_no_label_align_with_lora.json", args.pipeline_run_dir)
